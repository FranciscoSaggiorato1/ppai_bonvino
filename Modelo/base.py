...
s2 = Siguiendo(date(2022, 12, 21), date(2023, 8, 20), None, bod8)
s3 = Siguiendo(date(2024, 1, 12), date(2024, 5, 31), None, bod9)
...
s17 = Siguiendo(date(2022, 12, 27), date(2023, 6, 4), e1, None)
s7 = Siguiendo(date(2022, 9, 27), date(2023, 6, 4), e3, None)
e4 = Enofilo("Rodríguez", "https://www.stelorder.com/wp-content/uploads/2021/09/portada-empresario-individual.jpg", "Andres", [s7], u4)
s5 = Siguiendo(date(2022, 11, 8), date(2023, 7, 5), e4, None)
...
s18 = Siguiendo(date(2023, 6, 22), date(2023, 12, 13), e2, None)
s19 = Siguiendo(date(2024, 12, 1), date(2024, 9, 6), None, bod7)
s20 = Siguiendo(date(2023, 3, 19), date(2024, 4, 4), e4, None)
...
s8 = Siguiendo(date(2023, 3, 22), date(2023, 12, 13), e9, None)
s9 = Siguiendo(date(2024, 2, 1), date(2024, 9, 6), e10, None)
...
s15 = Siguiendo(date(2022, 4, 8), date(2023, 7, 5), e5, None)
s16 = Siguiendo(date(2024, 8, 3), date(2024, 1, 10), None, bod2)
e8 = Enofilo("Hernández", "https://www.hacerempresa.uy/wp-content/uploads/2023/04/Ent_Scagani_home.jpg", "Laura", [s15, s16], u8)
s4 = Siguiendo(date(2023, 5, 9), date(2024, 2, 29), e8, None)
s11 = Siguiendo(date(2022, 11, 4), date(2024, 3, 15), e3, None)
s12 = Siguiendo(date(2022, 2, 21), date(2023, 8, 20), None, bod10)
s13 = Siguiendo(date(2024, 7, 12), date(2024, 5, 31), None, bod9)
...
s10 = Siguiendo(date(2023, 7, 19), date(2024, 4, 4), e6, None)
