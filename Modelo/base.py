...
m6 = Maridaje("Vino blanco Sauvignon Blanc con ceviche de pescado.", "Sauvignon Blanc y Ceviche")
...
v4 = Vino(2017, date(2024, 1, 20), "Wenete", "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhraOeDvzt__vdJSKaeQfP4hFbr1rBuTBxj5aNmelCO9mF6HZvnweazd58ivUzaEWOFM7XX867PbfewEmtTmcDepPU_fes1Z3v8jRaawxq5a0g-59FCQTcZwn30_7RGr9MSM9XNmyXVOTZq/s1600/Portada+Como+leer+una+etiqueta+de+vino+Entre+Copas+y+Corchos+01.jpg", "Notas de frambuesa y especias", 2200, [m1, m6], [var6, var9, var10, var1], bod2)
v5 = Vino(2021, date(2024, 4, 18), "Desquiciado", "https://eltriunfodebaco.com.ar/wp-content/uploads/2021/08/etiqueta-M.-Gutelli.png", "Notas de manzana y miel", 1600, [m3, m9, m5], [var5, var7], bod2)
v6 = Vino(2016, date(2024, 2, 25), "Cordero con piel de lobo", "https://images.vivino.com/thumbs/yFVa6xmeRRqhiBR7FjsrPw_pl_480x640.png", "Notas de mora y regaliz", 1900, [m4, m7, m10], [var3, var10, var8], bod2)
v7 = Vino(2018, date(2024, 3, 30), "LAN D-12", "https://www.casagourmet.es/blog/wp-content/uploads/2023/01/03072017-LAN-D-12-botella-sin-anada_-1024x641.jpg", "Notas de flores blancas y cítricos", 1400, [m4, m8, m9], [var2, var6], bod3)
v8 = Vino(2019, date(2024, 1, 10), "San Cobate", "https://www.abzimpresores.es/wp-content/uploads/2023/02/confinamiento-conceptual-98.webp", "Notas de frutos rojos y tabaco", 1700, [m2, m5], [var1], bod4)
v9 = Vino(2020, date(2024, 2, 14), "Etymo", "https://brandemia.org/contenido/subidas/2021/12/01-etymo-etiquetavino.jpg", "Notas de frutos negros y vainilla", 1500, [m1, m9], [var3, var7, var8, var10], bod4)
v10 = Vino(2021, date(2024, 3, 22), "Krauel", "https://almargen.com/wp-content/uploads/2021/05/detalle_blanco_Krauel.jpg", "Notas de lima y hierbas", 1600, [m4], [var3, var5], bod5)
v11 = Vino(2015, date(2024, 5, 10), "Rutini", "https://clickandfoods.com/cdn/shop/files/AL7A6dlCTTSyYa-wR_Jxmw_pl_375x500_a0f35c07-1444-4a43-a1e4-37ddcdde9f9d.png?v=1712513920", "Notas de cafe", 2000, [m7, m10], [var2, var6], bod5)
v12 = Vino(2021, date(2024, 6, 5), "Vega Real", "https://www.empacke.com/wp-content/uploads/2018/05/vegareal-empacke-1.jpg", "Notas de piña y caramelo", 1900, [m2, m8], [var3, var8], bod6)
v13 = Vino(2017, date(2024, 2, 3), "Durigutti", "https://http2.mlstatic.com/D_NQ_NP_786367-MLA51681595255_092022-O.webp", "Notas de cereza", 1900, [m1, m9], [var3, var6], bod7)
v14 = Vino(2021, date(2024, 6, 5), "Matina", "https://www.ofifacil.com/portfolio/diseno-etiquetas-aceite-vino-envases-packaging-design-wine-oil-labels/matina/diseno-etiqueta-vino-matina-wine-label-design-2.jpg", "Notas de piña", 1900, [m1, m6], [var7, var8], bod7)
v15 = Vino(2016, date(2024, 1, 11), "Puerta Grande", "https://sacesaseleccion.com/1296-thickbox_default/vino-rosado-etiqueta-botella-3-4-l-125-vol.jpg", "Notas de Lima", 1900, [m8, m4], [var5, var6], bod7)
v16 = Vino(2021, date(2024, 6, 5), "Sol Naciente", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR6MhQZqo3-LlJc7OmTtCUhtcF-xv9xK4vfRCvpN-oUHQ&s", "Notas de piña y caramelo", 1900, [m2, m8], [var3, var8], bod8)
v17 = Vino(2022, date(2024, 6, 20), "Brisas del Sur", "https://f.fcdn.app/imgs/c4ae25/lasacristia.com.uy/scr/22df/original/catalogo/120135412013541/450_600/brisas-blend-selection-brisas-blend-selection.jpg", "Notas de cítricos, pomelo y hierbas frescas", 1700, [m4], [var2, var5, var9], bod8)
v18 = Vino(2019, date(2024, 6, 5), "Viñedos Escondidos", "https://almadelosandes.com.ar/wp-content/uploads/2021/03/ESCONDIDO-1.jpg", "Notas de ciruela, cereza y chocolate", 2800, [m2], [var3, var8], bod9)
v19 = Vino(2021, date(2024, 6, 10), "El Amanecer", "https://acdn.mitiendanube.com/stores/087/677/products/amanecer_andino_blend1-5680bf48e1777e172516675914347280-640-0.png", "Notas de manzana verde, pera y flores blancas", 1600, [m7, m9], [var1, var5, var9], bod9)
v20 = Vino(2023, date(2024, 6, 20), "La Joya del Desierto", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTG3rPQ87cDFinwAQSV6DhTwULN3GNdkIwiop12VKgV-A&s", "Notas de dátiles, higos y miel", 2001, [m1, m5], [var1, var5, var9], bod10)
v21 = Vino(2018, date(2024, 7, 1), "Aurora", "https://www.sawinery.com/wp-content/uploads/2021/04/unnamed-6.jpg", "Notas de frutas tropicales y vainilla", 1800, [m2, m6], [var1, var3, var7], bod11)
v22 = Vino(2019, date(2024, 7, 2), "Nebula", "https://www.nakedwines.com.au/wineImages/67294.jpg", "Notas de cereza negra y especias", 2000, [m3, m8], [var2, var5], bod11)
v23 = Vino(2020, date(2024, 7, 3), "Aromas del Bosque", "https://media.istockphoto.com/vectors/red-wine-bottle-label-with-woodland-and-forest-background-vector-id934828912?k=6&m=934828912&s=612x612&w=0&h=6u-W75mZjHxMmSf8Lr6zlR1lyR2veT99I87eJiOGbGA=", "Notas de bayas silvestres y roble", 2100, [m1, m7], [var3, var8], bod12)
v24 = Vino(2017, date(2024, 7, 4), "Luminoso", "https://i.etsystatic.com/8766829/r/il/8e2bc4/1701891673/il_570xN.1701891673_3qxp.jpg", "Notas de frutas rojas y chocolate", 1900, [m4, m9], [var4, var9], bod13)
v25 = Vino(2021, date(2024, 7, 5), "Serendipia", "https://www.cuvashop.com/2182-large_default/vino-serendipia.jpg", "Notas de durazno y almendra", 2200, [m5, m10], [var2, var6, var10], bod13)
v26 = Vino(2016, date(2024, 7, 6), "Travesía", "https://www.creativefabrica.com/wp-content/uploads/2021/01/Wine-Bottle-Label-By-Bartemis-Studio-5.jpg", "Notas de frutos negros y cuero", 1700, [m2, m8], [var1, var5, var8], bod13)
v27 = Vino(2018, date(2024, 7, 7), "Amanecer en la Viña", "https://m.media-amazon.com/images/I/61VtORt0c6L._AC_SY450_.jpg", "Notas de frutas blancas y almendras", 2000, [m3, m9], [var3, var7, var9], bod14)
v28 = Vino(2019, date(2024, 7, 8), "Luz de Luna", "https://img.vinepair.com/wp-content/uploads/2020/11/white-wine-label-internal.jpg", "Notas de pera y miel", 1800, [m4, m10], [var2, var4, var8], bod15)
v29 = Vino(2020, date(2024, 7, 9), "Alborada", "https://cdn.shopify.com/s/files/1/0504/1766/6671/products/Alborada_Tardia1_500x.jpg?v=1609577670", "Notas de manzana y caramelo", 1900, [m5, m6], [var1, var6, var10], bod15)
v30 = Vino(2021, date(2024, 7, 10), "Bruma Matinal", "https://i.pinimg.com/originals/31/9a/57/319a5733141b7fb69b6c4c00000e47b3.jpg", "Notas de melocotón y vainilla", 2100, [m7, m8], [var3, var5, var9], bod16)
v31 = Vino(2017, date(2024, 7, 11), "Destellos de Estío", "https://cdn.shopify.com/s/files/1/0004/0219/1437/products/bodegas-alnus-ribera-del-duero-vino-tinto-crianza-2020-sel-pun-id-2878848_550x550.png?v=1617635723", "Notas de ciruela y chocolate", 2200, [m9, m10], [var2, var7, var8], bod17)
v32 = Vino(2018, date(2024, 7, 12), "Sinfonía de Uvas", "https://static.wixstatic.com/media/5d5612_e0835b8a7e524a49bc8c55e3d24f9400~mv2.jpg/v1/fill/w_1400,h_1400,al_c,q_90/5d5612_e0835b8a7e524a49bc8c55e3d24f9400~mv2.jpg", "Notas de bayas y vainilla", 1900, [m1, m2, m3], [var1, var3, var10], bod17)
v33 = Vino(2020, date(2024, 7, 13), "Cielo Nocturno", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2bDF4Niwb4p0aQJ8D3xTQWJf3UAK54TeHyW-dGZWP-w&s", "Notas de arándanos y especias", 2100, [m2, m5, m8], [var2, var5, var7], bod18)
v34 = Vino(2022, date(2024, 7, 14), "Alma del Valle", "https://www.casillerodeldiablo.com/ar/wp-content/uploads/2021/04/750_Wine_Devil-Reserva_CabSauv_Agosto2019_Mesa-Trabajo-1-1-1.jpg", "Notas de frutos rojos y especias", 2500, [m2, m7], [var4, var8, var9], bod18)
v35 = Vino(2023, date(2024, 7, 15), "Celestia", "https://www.nakedwines.com.au/wineImages/86990.jpg", "Notas de frutas tropicales y flores blancas", 2300, [m3, m8], [var1, var5, var6], bod19)
v36 = Vino(2024, date(2024, 7, 16), "Néctar de las Hadas", "https://images-na.ssl-images-amazon.com/images/I/51GgCxQWe4L._AC_SY450_.jpg", "Notas de fresas y crema", 2700, [m4, m9], [var2, var7, var10], bod20)
...
s6 = Siguiendo("2023-04-03", "2024-01-10", None, bod6)
...
s1 = Siguiendo("2023-10-04", "2024-03-15", e3, None)
s2 = Siguiendo("2022-12-21", "2023-08-20", None, bod8)
s3 = Siguiendo("2024-01-12", "2024-05-31", None, bod9)
...
s17 = Siguiendo("2022-12-27", "2023-06-04", e1, None)
s7 = Siguiendo("2022-09-27", "2023-06-04", e3, None)
e4 = Enofilo("Rodríguez", "https://www.stelorder.com/wp-content/uploads/2021/09/portada-empresario-individual.jpg", "Andres", [s7], u4)
s5 = Siguiendo("2022-11-08", "2023-07-05", e4, None)
e2 = Enofilo("Fernández", "https://previews.123rf.com/images/ariwasabi/ariwasabi1102/ariwasabi110200029/8871278-retrato-de-hombre-joven-guapo-aislada-sobre-fondo-blanco-cauc%C3%A1sico-hombre-con-barba-sonriendo.jpg", "Marcos", [s3, s5], u2)
s18 = Siguiendo("2023-06-22", "2023-12-13", e2, None)
s19 = Siguiendo("2024-12-01", "2024-09-06", None, bod7)
s20 = Siguiendo("2023-03-19", "2024-04-04", e4, None)
...
s8 = Siguiendo("2023-03-22", "2023-12-13", e9, None)
s9 = Siguiendo("2024-02-01", "2024-09-06", e10, None)
...
s15 = Siguiendo("2022-04-08", "2023-07-05", e5, None)
s16 = Siguiendo("2024-08-03", "2024-01-10", None, bod2)
e8 = Enofilo("Hernández", "https://www.hacerempresa.uy/wp-content/uploads/2023/04/Ent_Scagani_home.jpg", "Laura", [s15, s16], u8)
s4 = Siguiendo("2023-05-09", "2024-02-29", e8, None)
s11 = Siguiendo("2022-11-04", "2024-03-15", e3, None)
s12 = Siguiendo("2022-02-21", "2023-08-20", None, bod10)
s13 = Siguiendo("2024-07-12", "2024-05-31", None, bod9)
...
s10 = Siguiendo("2023-07-19", "2024-04-04", e6, None)
e7 = Enofilo("García", "https://impulsapopular.com/wp-content/uploads/2020/02/4645-Lectura-recomendada-cero-a-empresario.jpg", "José", [s10, s13], u7)
s14 = Siguiendo("2023-05-19", "2024-02-29", e7, None)
